...
const PRODUCTS = [
  ...
  {category: "Chair", price: "£525.00", stocked: true, name: "DirectoireCarvedBack"},
  {category: "Chair", price: "£550.00", stocked: true, name: "RochembeauCarvedBack"},
  {category: "Chair", price: "£575.00", stocked: false, name: "HeritageCarvedBack"},
  {category: "Armchair", price: "£600.00", stocked: true, name: "DirectoireUpholstered"},
  {category: "Armchair", price: "£650.00", stocked: true, name: "RochembeauUpholstered"},
  {category: "Armchair", price: "£675.00", stocked: false, name: "HeritageUpholstered"},
  {category: "Sideboard", price: "£4995.00", stocked: false, name: "RochembeauTriple"},
  {category: "Sideboard", price: "£3995.00", stocked: true, name: "HeritageDouble"},
  {category: "Sideboard", price: "£4500.00", stocked: true, name: "DirectoireDouble"},
